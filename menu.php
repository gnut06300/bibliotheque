        <nav class="navbar navbar-expand-lg navbar-dark nav-custom">
          ...
          <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav">
              ...
              <li class="nav-item <?php if(isset($_GET['table']) AND $_GET['table']=='livre') echo 'active'; ?>">
                <a class="nav-link" href="?table=livre">Livres</a>
              </li>
              <li class="nav-item <?php if(isset($_GET['table']) AND $_GET['table']=='personne') echo 'active'; ?>">
                <a class="nav-link" href="?table=personne" >Membres</a>
              </li>
              <li class="nav-item <?php if(isset($_GET['table']) AND $_GET['table']=='emprunt') echo 'active';?>">
                <a class="nav-link" href="?table=emprunt" >Emprunts</a>
              </li>
              <li class="nav-item <?php if(isset($_GET['contact']) AND $_GET['contact']=='yes') echo 'active';?>">
